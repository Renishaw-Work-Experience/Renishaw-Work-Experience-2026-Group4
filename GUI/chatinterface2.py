...
sendimage = customtkinter.CTkImage(light_image=Image.open("4008617.png"), size=(50,50))

newchatimage = customtkinter.CTkImage(light_image=Image.open("13122628.png"), size=(50,50))
